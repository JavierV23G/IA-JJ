...
const AdminSpeechTherapy = ({ therapists, patientId }) => {
  const [showGoals, setShowGoals] = useState(false);
  const [currentFrequency, setCurrentFrequency] = useState("1W2");
  const [isEditing, setIsEditing] = useState(false);
  
  const primaryTherapist = therapists.find(t => t.role === 'ST');
  const assistantTherapist = therapists.find(t => t.role === 'STA');
  ...
  return (
    <div className="discipline-therapy speech">
        ...
        <div className="therapists-container">
          <div className="therapist-row">
            <div className="role-label">
              <span>Primary</span>
              <div className="role-badge st">ST</div>
            </div>
          ...
          <div className="therapist-row">
            <div className="role-label">
              <span>Assistant</span>
              <div className="role-badge sta">STA</div>
            </div>
      ...
      <div className="therapy-footer">
        <div className="last-updated">
          ...
          <span>Last updated: 03/08/2025</span>
        </div>
...
export default AdminSpeechTherapy;